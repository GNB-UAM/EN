...
class Puro(Modulacion):
        ...
        def valor_sensor(self,count,string,gas):
                ...
                Modulacion.queue.put(["%d %f %f 100 %s"%(count,valueTGS2600,RsTGS2600,instante_captura),"%s[%d] Valor(mV): %f Rs(ohmios): %f Temperatura(%5V): 100 Instante_Captura: %s"%(string,count,valueTGS2600,RsTGS2600,instante_captura),gas])
